...
export function ProductCard  ({id, name, guardado, imageUri, arrayTratos, navigation}: CardProps) {  
  var prestar = false;
  ...
  return (
    <>
    <TouchableOpacity onPress={() => navigation.navigate("ProductRead", id)} style={styles.container}>
