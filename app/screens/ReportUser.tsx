...
export default function ReportUser({ navigation, route }: RootTabScreenProps<'ReportUser'>) {
  ...
  return (
    ...
    <ScrollView>
        <View style={styles.container}>
            <Text style={[styles.title, { marginTop: 20 }]}> {t('¿Cuál es el problema con este usuario?')}</Text>
